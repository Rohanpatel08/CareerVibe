...
class JobController extends Controller
{
    ...
    public function myJobs(myJobsDataTable $dataTable)
    {
        $user = Auth::user();
        // $jobs = CareerJob::where('user_id', $user->id)->orderBy('created_at', 'DESC')->paginate(5);

        return $dataTable->render('front.job.my-jobs', ['user' => $user]);
    ...
    public function myJobApplications()
    {
        ...
        // return $datatable->render('front.job.my-applied-jobs', ['user' => $user]);
