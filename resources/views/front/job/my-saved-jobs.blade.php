                                        ...
                                        @foreach ($jobs as $job)
                                            <tr class="active">
                                                <td>
                                                    ...
                                                    <div class="info1">{{ $job->job->jobType->job_type }} .
                                                        {{ $job->job->location }}
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="job-status text-capitalize">
                                                        {{ $job->job->status == 1 ? 'active' : 'pending' }}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="action-dots float-end">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li><a class="dropdown-item"
                                                                    href="{{ route('job.details', base64_encode($job->job->id)) }}">
